                        ...
                        <div class="mb-8">
                            ...
                            <table border="1" cellpadding="10" class="w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center text-sm w-1/3">{{ $product->name }}</td>
                                        <td class="text-center text-sm w-1/3">{{ $product->price }}</td>
                                        <td>
                                            <input class="w-24 block m-auto placeholder:text-gray-500 rounded-md border-2 border-red-400" type="number" min="{{ $product->stock_reposition }}" wire:model="quantity" placeholder="{{ $product->stock_reposition }}">
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
