                        ...
                        <tbody>          
                                @foreach($specialties as $specialty)
                                    <tr class="bg-gray-200 border-b ">
                                        ...
                                        <td class="px-3 py-2 text-center text-xl text-gray-900">
                                            <a wire:navigate href="{{ route('edit.specialty', ['id' => $specialty->id]) }}" class="text-xl"><i class="fas fa-edit text-blue-600 hover:text-blue-400 duration-300"></i></a>
    ...
    function confirmDelete(specialtyId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Livewire.dispatch('deleteConfirmed', {specialtyId});
