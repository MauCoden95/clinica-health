            ...
            <div class="w-full flex justify-between">
                ...
                <form wire:submit.prevent="editSpecialty" class="flex items-center justify-between gap-3">
                    <div class="w-3/6 mb-4">
                        ...
                        <input type="text" id="specialty" wire:model="specialty" class="w-full px-3 py-2 border rounded-lg">
                    </div>
                    <button type="submit" class="w-3/6 h-12 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 duration-300">
