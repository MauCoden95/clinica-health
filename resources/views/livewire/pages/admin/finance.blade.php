    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="w-full flex-1 overflow-x-hidden overflow-y-auto bg-white">
            <div class="relative w-full px-14 overflow-x-auto mt-20 flex justify-between">
                ...
                <x-common.count_finance :item="'Egresos de hoy'" :quantity="$todayExpenses->sum('amount')" :icon="'fas fa-money-bill-wave-alt'" />
            ...
            <x-common.graph.incomes_last_six_months
                :lastSixMonths="$lastSixMonths"
                chart-id="incomesSixMonthsChart"
