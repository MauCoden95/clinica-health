<div class="">
    ...
    <nav class="w-full h-auto duration-300">
        ...
        <ul class="p-4 space-y-2">
            <li>
                <a class="flex lg:text-xl items-center px-4 py-1.5 text-sm text-gray-700 rounded-md hover:bg-gray-300 duration-300"
            ...
            <li>
                <a class="flex text-xl items-center px-4 py-1.5 text-sm text-gray-700 rounded-md hover:bg-gray-300 duration-300"
            ...
            <li>
                <a wire:navigate href="http://localhost:8000/admin/quejas-y-sugerencias"
                    class="flex lg:text-xl items-center px-4 py-1.5 text-sm text-gray-700 rounded-md hover:bg-gray-300">
            ...
            <li>
                <a wire:navigate href="http://localhost:8000/admin/estadisticas" class="flex lg:text-xl items-center px-4 py-1.5 text-sm text-gray-700 rounded-md hover:bg-gray-300 duration-300"
                    wire:navigate>
